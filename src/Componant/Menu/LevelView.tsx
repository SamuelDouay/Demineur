    ...
    return (
        <div className="w-full  flex items-center justify-between flex-col" id="level">
            ...
            <div className="mb-4 relative flex flex-col justify-between text-center w-full space-y-2">
                <MenuButton densite={0.10} name="Novice" />
                <MenuButton densite={0.20} name="Amateur" />
                <MenuButton densite={0.30} name="Intermediare" />
                <MenuButton densite={0.40} name="Confirmé" />
                <MenuButton densite={0.45} name="Expert" />
            </div>
        </div>
    );
}
